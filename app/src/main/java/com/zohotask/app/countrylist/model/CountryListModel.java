package com.zohotask.app.countrylist.model;
...
public class CountryListModel {
    ...
    @Expose
    private List<RegionalBlocModel> regionalBlocs = null;
    @SerializedName("cioc")
    @Expose
    private String cioc;
    ...
    public void setTranslations(TranslationModel translations) {
    ...
    public List<RegionalBlocModel> getRegionalBlocs() {
        return regionalBlocs;
    }

    public void setRegionalBlocs(List<RegionalBlocModel> regionalBlocs) {
